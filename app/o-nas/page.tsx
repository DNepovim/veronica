    ...
    <>
      ...
      <div className="relative p-10">
        ...
        <main className="relative mb-16">
          ...
          <p>
            Kdo je Veronica? Veronica je sebe rozvojový kurz pro skauty
            a skautky, kteří se chystají absolvovat vůdcovskou zkoušku, nebo se
            prostě jen dozvědět něco o sobě a světu kolem nich. Za svých
            třiadvacet let si prošla personifikací jako malokterý jiný kurz
            a mluvit o ní ve středním rodě by se se zlou potázalo. Je trochu
        ...
        <Link
          href="#top"
          className="bold rounded-def bg-black px-6 pt-1 text-2xl text-white"
        >
          zpět nahoru
        </Link>
